    ...
    <div class="card">
        <div class="card-body row align-items-start">
            <div class="col">
                ...
                <form action="check_insert_order.php?c=<?php echo $add ?>&t_name=<?php echo $_GET['name'] ?>" method="post">
                    <div class="card card-body" style="background-color: #f4f4f4;">
                        <div class="container-lg">
                            ...
                            <h1 class="col-auto text-end"><a class="btn  ">ใบจอง</a>C</h1>
                            ...
                            <div class="container-lg">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>           <label style="color:brown">* </label>2.เข็มขัดและหัวเข็มขัด :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>               <label style="color:brown">* </label>3.เน็คไทและเข็ม :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                        placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre><label style="color:brown">* </label>4.กระเป๋าเป้วิทยาลัยเทคนิคหาดใหญ่ :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre> <label style="color:brown">* </label>5.สมุดตราวิทยาลัยเทคนิคหาดใหญ่ :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>         6.เสื้อนักเรียนสีขาวแขวยาว :</pre>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>        7.กางเกงขายาว สีดำ เอว :</pre>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>          8.รองเท้าผ้าใบสีดำ เบอร์ :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>
