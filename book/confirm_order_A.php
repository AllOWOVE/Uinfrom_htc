            ...
            <div class="row justify-content-center">
                <div class="col">
                    <div class="card   rounded-lg mt-3" style="border: 0;">
                        <form action="../tcpdf/Apdf.php?a=<?php echo $a ?>" method="post" target="_blank">
                            <div class="card-body">
                                <div class="card-body">
                                    <div class=" text-start py-9 mt-2 rounded ">
                                        <button type="submit" class="btn btn-primary"><i class="fas fa-print"></i> พิมพ์</button>
                                    </div>
                                    <h2 class="text-end"><?php echo $student_id; ?>&nbsp;<span class="badge bg-light text-dark border">A</span></h2>
