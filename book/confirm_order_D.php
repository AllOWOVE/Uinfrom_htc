    ...
    <div class="card">
        <div class="container-lg">
            <div class="row justify-content-center">
                <div class="col">
                    <div class="card   rounded-lg mt-5" style="border: 0;">
                        <form action="../tcpdf/Dpdf.php?a=<?php echo $a ?>" method="post" target="_blank">
                            <div class="card-body">
                                <div class=" text-start py-9 mt-2 rounded ">
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-print"></i> พิมพ์</button>
                                </div>
                                <h2 class="text-end mt-2"><?php echo $student_id; ?>&nbsp;<span class="badge bg-light text-dark border">D</span></h2>
                                <table class="table table-striped table-bordered" style="border-color: #000000">
                                    <tr>
                                        <th style="width:9%;">ชื่อ-สกุล</th>
                                        <td>
                                            <?php
                                ...
                                <?php if (isset($_GET['a'])) { ?>
                                    <table class="table  table-bordered" style="border-color: #000000">
                                        <tr>
                                            <th style="width:9%;" class="text-center">ลำดับ</th>
                                            <th>รายการ</th>
                                            <th>ขนาด</th>
                                            <th>ราคา/หน่วย</th>
                                            <th>จำนวน</th>
