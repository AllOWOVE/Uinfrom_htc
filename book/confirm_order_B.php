    ...
    <div class="card">
        <div class="container-lg">
            <div class="card-body text-start">
                <label>
                    <h4>ทำการจองเสร็จสิ้น</h4>
                    <p>สามารถติดตามข่าวสารหรือวันเวลาการรับอุปกรณ์ </p>
    ...
    <div class="card">
        <div class="container-lg">
            <div class="row justify-content-center">
                <div class="col">
                    <div class="card   rounded-lg mt-3" style="border: 0;">
                        <form action="../tcpdf/Bpdf.php?a=<?php echo $a ?>" method="post" target="_blank">
                            <div class="card-body">
                                <div class="card-body">
                                    <div class=" text-start py-9 mt-2 rounded ">
                                        <button type="submit" class="btn btn-primary"><i class="fas fa-print"></i> พิมพ์</button>
                                    </div>
                                    <h2 class="text-end"><?php echo $student_id; ?>&nbsp;<span class="badge bg-light text-dark border">B</span></h2>
                                    <table class="table  table-bordered" style="border-color: #000000">
                                        <tr>
                                            <th class="table-active">ชื่อ-สกุล</th>
                                            <td>
                                                <?php
                                            ...
                                            <th class="table-active">เเผนก</th>
                                            <td>
                                                <?php
                                                echo $branch_name;
                                                ?>
                                        ...
                                        <tr>
                                            <th class="table-active">โทรศัพท์</th>
                                            <td>
                                                <?php
                                                echo $tel
                                                ?>
                                            </td>
                                            <th class="table-active">วันที่</th>
                                            <td>
                                                <?php
                                                echo $date;
                                                ?>
                                    ...
                                    <div class=" text-end py-9 mt-5 rounded ">
                                        <label>**หมายเหตุ:เมื่อทำการจองเเล้วจะไม่สามารถยกเลิกการจองได้อีก ต้องการยกเลิกหรือไม่**</label>
                                        <a href="../admin/delete_v.php?idcos=<?php echo $student_id ?>" class="btn btn-danger " name="confirm_voc" onclick="return confirm('คุณเเน่ใจใช่ไหมว่าจะลบข้อมูล') ">ยกเลิกการจอง</a>
                                        <button type="submit" class="btn btn-primary"><i class="fas fa-print"></i> พิมพ์</button>
                        </form>
                    </div>
                </div>
        ...
        <div class=" text-center py-9 mt-2 rounded ">
            <br>
            <br>
            <br>
            <br>
