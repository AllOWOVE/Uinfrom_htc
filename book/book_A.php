    ...
    <div class="card">
        <div class="card-body row align-items-start">
            <div class="col">
                ...
                <form action="check_insert_order.php?a=<?php echo $add ?>&t_name=<?php echo $_GET['name'] ?>" method="post">
                    <div class="card card-body" style="background-color: #f4f4f4;">
                        <div class="container-lg">
                            ...
                            <h1 class="col-auto text-end"><a class="btn  ">ใบจอง</a>A</h1>
                            <br>
                            <div class="container-lg">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto ">
                                        <pre>       <label style="color:brown">* </label>2.เสื้อยืดฝึกฝีมือ (คอกลม) :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <select class="form-select" id="size02" name="size02">
                                            <option value="0">ขนาด</option>
                                            <option value="2001">S</option>
                                            <option value="2002">M</option>
                                            <option value="2003">L</option>
                                            <option value="2004">XL</option>
                                            <option value="2005">2XL</option>
                                        </select>
                                    </div>
                                    <div class="col-auto">
                                        <label>140 บาท/หน่วย</label>
                                    </div>
                                    <div class="col-auto">
                                        <label>จำนวน</label>
                                    </div>
                                    <div class="col-auto">
                                        <select class="form-select" id="count02" name="count02">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto ">
                                        <pre>                   <label style="color:brown">* </label> 3.เสื้อพละ :</pre>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto ">
                                        <pre>                <label style="color:brown">* </label> 4.กางเกงพละ :</pre>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>           <label style="color:brown">* </label>5.เข็มขัดและหัวเข็มขัด :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>               <label style="color:brown">* </label>6.เน็คไทและเข็ม :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                        placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre><label style="color:brown">* </label>7.กระเป๋าเป้วิทยาลัยเทคนิคหาดใหญ่ :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre> <label style="color:brown">* </label>8.สมุดตราวิทยาลัยเทคนิคหาดใหญ่ :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>-->
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>         9.เสื้อนักเรียนสีขาวแขวสั้น :</pre>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>       10.กางเกงขายาว สีกรม เอว :</pre>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        <pre>         11.รองเท้าผ้าใบสีดำ เบอร์ :</pre>
                                    </div>
                                    <div class="col-auto">
                                        <!--<input type="text" class="form-control"
                                                                                    placeholder="ขนาด" required>
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-auto text-end">
                                        ...
                                        <!--<input type="text" class="form-control"
                                                                                placeholder="จำนวน" value="1" readonly>-->
                                        <label>90 บาท/หน่วย</label>
                                    </div>
                                    <div class="col-auto">
                                        <label>จำนวน</label>
                                    </div>
                                    <div class="col-auto ">
                                        <select class="form-select " id="count13" name="count13">
                                            <option value="0">0</option>
                                            <option value="1">1</option>
                                        </select>
                                    </div>
