...
if (isset($_GET['idv'])) {
    ...
    $sqlEdit = "SELECT * FROM voc WHERE id = $idv";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update the record
    $sqlUpdate = "UPDATE voc SET branch_id = '$branch_id', branch_name = '$branch_name', `group` = '$group' WHERE id = $idv";
                        ...
                        <div class="col-sm-5">
                            <div class="card-body">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="branch_id" value="<?php echo $rowEdit['branch_id']; ?>" required>
                                    </div>
                                    <div class="mt-2">
                                        <label for="branch_name">Branch Name:</label>
                                    </div>
