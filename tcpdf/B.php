            ...
            <td style="width:49%;">
                <table>
                    <tr>
                        ...
                        <td style="width:10%;background-color:#D7D7D7;border: 1px solid black; text-align: center;"><h2>B</h2></td>
                    </tr>
                    <tr>
                    ...
                    <br>
                    <tr>
                        <td style=" width:101%; border: 1px solid black; text-align: center;"><h2>รายการจองอุปกรณ์การเรียนของนักศึกษา ปวช.</h2></td>
                    </tr> 
                    <br>
                    <tr>
                    ...
                    $sum = 0; 
                        ...
                        if (isset($list_size9)) {$n += 1; ?>
                            <tr>
                                <td style=" width:11%; border: 1px solid black; text-align: center; background-color:#D7D7D7;"><h2><?php echo $n; ?></h2></td>
                                <td style=" width:45%; border: 1px solid black; "><h2><?php if ($t_name == "นางสาว" or $t_name == "นาง" or $t_name == "เด็กหญิง") { ?> เสื้อนักเรียนสีขาว แขนสั้น(หญิง)
                                    <?php } else { ?> เสื้อนักเรียนสีขาว แขนสั้น(ชาย)
                                <?php } ?>
                                <?php ?></h2></td>
                        ...
                        if (isset($list_size13)) {$n += 1; ?>
                            ...
                            <td style=" width:8%; border: 1px solid black; text-align: center; background-color:#D7D7D7;"><h2>90</h2></td>
                        ...
                        if (isset($sizef)) {$n += 1; ?>
                            ...
                            <td style=" width:15%; border: 1px solid black; text-align: center;"><h2>280</h2></td>
                        ...
                        <tr>
                            <td style=" width:101%; "><h3>หมายเหตุ
                                <br>1.เมื่อชำระเงินเเล้วไม่สามารถเรียกคืนได้
                                <br>2.รับอุปกรณ์ที่สั่งจอง(ย้อนหลัง)ได้ที่ร้านค้าสวัสดิการ
                            </h3></td>
                        </tr> 
