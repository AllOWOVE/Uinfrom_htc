            ...
            <td style="width:49%;">
                <table>
                    <tr>
                        ...
                        <td style="width:10%;background-color:#D7D7D7;border: 1px solid black; text-align: center;"><h2>C</h2></td>
                    </tr>
                    <tr>
                    ...
                    <br>
                    <tr>
                        <td style=" width:101%; border: 1px solid black; text-align: center;"><h2>รายการจองอุปกรณ์การเรียนของนักศึกษา ปวส. <u>ยกเว้น</u> ปิโตรเลียม</h2></td>
                    </tr> 
                    <br>
                    <tr>
                        ...
                        <td style=" width:45%; border: 1px solid black;"><h4><?php
                            echo $branch_name;
                            ?></h4>
                        </td>
                    </tr>                    
                    ...
                    $sum = 0; 
                        ...
                        if (isset($list_size10)) {$n += 1; ?>
                            <tr>
                            <td style=" width:11%; border: 1px solid black; text-align: center; background-color:#D7D7D7;"><h2><?php echo $n; ?></h2></td>
                            <td style=" width:45%; border: 1px solid black; "><h2> กางเกงขายาว สีดำ (เอว)</h2></td>
                        ...
                        if (isset($sizef)) {$n += 1; ?>
                            <tr>
                            <td style=" width:11%; border: 1px solid black; text-align: center; background-color:#D7D7D7;"><h2><?php echo $n; ?></h2></td>
                            <td style=" width:45%; border: 1px solid black; "><h2> กระโปรง สีดำ (เอว)</h2></td>
